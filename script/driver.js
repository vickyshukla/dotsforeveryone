...
this.driver.js = (function (I) {
    ...
    (u.className = `driver-popover ${P}`.trim()),
      j(
        ...
        (y) => {
          ...
          if (x.classList.contains("ri-close-circle-fill"))
  ...
  function xe() {
    ...
    x.classList.add("driver-popover-header");
    const o = document.createElement("div");
    o.classList.add("driver-popover-title"),
      (o.style.display = "none"),
      (o.innerText = "Popover Title");
    const p = document.createElement("button");
    p.classList.add("driver-popover-close-btn"),
      (p.innerHTML = '<i class="ri-close-circle-fill"></i>');
    ...
    i.classList.add("driver-popover-prev-btn"), (i.innerHTML = "Back");
